...
This document serves both as the [GitHub documentation](https://github.com/TobiasPfaffeneder/tt-sky25b-can-you-count-binary-game/blob/main/docs/info.md) for my project and as the report for the lecture. Depending on where you are reading this, some sections may therefore appear slightly over-explained.A
...
![](https://tinytapeout.com/specs/pcb/images/tt04_board_annotated.jpeg)
...
The *Translate Filter Process* is a simple pyhton script that was provided by another student in the lecture forum:
...
Only three linter warnings occur in my project. These warnings originate from unused wires in the **BCD splitter** module. As explained earlier, these wires are required because the result of dividing an 8-bit number is also 8 bits wide. Although not all bits are used in the subsequent logic, the full width must be declared, which leads to the reported warnings.

```verilog
    %Warning-UNUSEDSIGNAL: /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/bcd_splitter.v:12:16: Bits of signal are not used: 'hundreds_full'[7:4]
                                                                                                                                             : ... note: In instance 'tt_um_dip_switch_game_TobiasPfaffeneder.display_ctrl.splitter'
       12 |     wire [7:0] hundreds_full = value / 8'd100;
          |                ^~~~~~~~~~~~~
                           /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/sevenseg_display_controller.v:6:1: ... note: In file included from 'sevenseg_display_controller.v'
                           /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/tt_um_dip_switch_game_TobiasPfaffeneder.v:10:1: ... note: In file included from 'tt_um_dip_switch_game_TobiasPfaffeneder.v'
                           ... For warning description see https://verilator.org/warn/UNUSEDSIGNAL?v=5.018
                           ... Use "/* verilator lint_off UNUSEDSIGNAL */" and lint_on around source to disable this message.
    %Warning-UNUSEDSIGNAL: /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/bcd_splitter.v:13:16: Bits of signal are not used: 'tens_full'[7:4]
                                                                                                                                             : ... note: In instance 'tt_um_dip_switch_game_TobiasPfaffeneder.display_ctrl.splitter'
       13 |     wire [7:0] tens_full = (value / 8'd10) % 8'd10;
          |                ^~~~~~~~~
                           /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/sevenseg_display_controller.v:6:1: ... note: In file included from 'sevenseg_display_controller.v'
                           /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/tt_um_dip_switch_game_TobiasPfaffeneder.v:10:1: ... note: In file included from 'tt_um_dip_switch_game_TobiasPfaffeneder.v'
    %Warning-UNUSEDSIGNAL: /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/bcd_splitter.v:14:16: Bits of signal are not used: 'ones_full'[7:4]
                                                                                                                                             : ... note: In instance 'tt_um_dip_switch_game_TobiasPfaffeneder.display_ctrl.splitter'
       14 |     wire [7:0] ones_full = value % 8'd10;
          |                ^~~~~~~~~
                           /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/sevenseg_display_controller.v:6:1: ... note: In file included from 'sevenseg_display_controller.v'
                           /home/runner/work/tt-sky25b-can-you-count-binary-game/tt-sky25b-can-you-count-binary-game/src/tt_um_dip_switch_game_TobiasPfaffeneder.v:10:1: ... note: In file included from 'tt_um_dip_switch_game_TobiasPfaffeneder.v'
```
